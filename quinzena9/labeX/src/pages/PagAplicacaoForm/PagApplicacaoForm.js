...
import { goToPagListaViagens } from '../../routes/coordinator'
import { ApplicationScreenContainer, ButtonsContainer } from "./styled"


const PagApplicacaoForm = () => {
    ...
    return (
        <ApplicationScreenContainer>
            ...
            <form onSubmit={onClickSend}>
                ...
                <ButtonsContainer>
                    <button onClick={() => goToPagListaViagens(history)}>Voltar</button>
...
export default PagApplicacaoForm
